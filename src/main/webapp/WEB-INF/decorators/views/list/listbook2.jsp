    ...
    <div class="container">
        <div class="sach">
            <ul class="breadcrumb">
                ...
                <li><a>Phiên bản</a></li>
                <li><a><c:out value="${typename.typeName}"/></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
        <div class="grid__row">
            ...
            <div class="col-lg-10 col-md-12 col-12 collection-content">
                <ul class="products">
                    <c:forEach var="booktype" items="${findBookByTypeID}">
                        <li>
                            <div class="product-item">
                                <div class="product-top">
                                    <a href="/productbook/${booktype.bookID}" class="product-thumb">
                                        <div class="image-wrapper">
                                            <img src="<c:out value="${booktype.avatar}"/> " alt="" class="">
                                        </div>
                                    </a>
                                </div>
...
<script>
    function handleCheckboxChange() {
        ...
        if (ageCheckbox && !priceCheckbox  && !languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value));
        }
        if (!ageCheckbox && priceCheckbox  && !languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?price=' + encodeURIComponent(priceCheckbox.value));
        }
        if (!ageCheckbox && !priceCheckbox  && languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?language=' + encodeURIComponent(languageCheckbox.value));
        }
        if (ageCheckbox && priceCheckbox  && !languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value)+'&price='+encodeURIComponent(priceCheckbox.value));
        }
        if (ageCheckbox && !priceCheckbox  && languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value)+'&language='+encodeURIComponent(languageCheckbox.value));
        }
        if (!ageCheckbox && priceCheckbox  && languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?price=' + encodeURIComponent(priceCheckbox.value)+'&language='+encodeURIComponent(languageCheckbox.value));
        }
        if (priceCheckbox && languageCheckbox && languageCheckbox) {
            updateProductList('/type/${findBookByTypeID[0].typeID.typeID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value)+'&price='+encodeURIComponent(priceCheckbox.value) +'&language='+encodeURIComponent(languageCheckbox.value));
        }
    }
