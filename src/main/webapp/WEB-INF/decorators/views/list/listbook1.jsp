    ...
    <div class="container">
        <div class="sach">
            <ul class="breadcrumb">
                ...
                <li><a><c:out value="${categoryname.categoryName}"/></a></li>
            </ul>
        </div>
    </div>
    <div class="container">
        <div class="grid__row">
                    ...
                    <dd class="even">
                        <ol class="checkbox-list-age">
                            <li>
                                ...
                                <a  class="m-checkbox-checked" onclick="handleClickAge('age-m-1')">18+</a>
                            </li>
                            <li>
            ...
            <div class="col-lg-10 col-md-12 col-12 collection-content">
                <ul class="products">
                    <c:forEach var="bookcate" items="${findBookByCategory}">
                        <li>
                            <div class="product-item">
                                <div class="product-top">
                                    <a href="/productbook/${bookcate.bookID}" class="product-thumb">
                                        <div class="image-wrapper">
                                            <img src="<c:out value="${bookcate.avatar}"/> " alt="" class="">
                                        </div>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="/listbook/type/${bookcate.typeID.typeID}" class="product-cat"><c:out value="${bookcate.typeID.typeName}"/></a>
                                    <a href="/productbook/${bookcate.bookID}" class="product-name"><c:out value="${bookcate.title}"/></a>
                                    <div class="product-price"><c:out value="${bookcate.price + bookcate.typeID.price}"/></div>
                                </div>
                            </div>
                        </li>
                    </c:forEach>
...
<script>
    function handleCheckboxChange() {
        ...
        if (ageCheckbox && !priceCheckbox  && !languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value));
        }
        if (!ageCheckbox && priceCheckbox  && !languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?price=' + encodeURIComponent(priceCheckbox.value));
        }
        if (!ageCheckbox && !priceCheckbox  && languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?language=' + encodeURIComponent(languageCheckbox.value));
        }
        if (ageCheckbox && priceCheckbox  && !languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value)+'&price='+encodeURIComponent(priceCheckbox.value));
        }
        if (ageCheckbox && !priceCheckbox  && languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value)+'&language='+encodeURIComponent(languageCheckbox.value));
        }
        if (!ageCheckbox && priceCheckbox  && languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?price=' + encodeURIComponent(priceCheckbox.value)+'&language='+encodeURIComponent(languageCheckbox.value));
        }
        if (priceCheckbox && languageCheckbox && languageCheckbox) {
            updateProductList('/category/${findBookByCategory[0].category.categoryID}/updateProductList?age=' + encodeURIComponent(ageCheckbox.value)+'&price='+encodeURIComponent(priceCheckbox.value) +'&language='+encodeURIComponent(languageCheckbox.value));
        }
    }
