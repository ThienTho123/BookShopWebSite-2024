...
<head>
    ...
    <link rel="stylesheet"
          ...
          integrity="sha512-sMXtMNL1zRzolHYKEujM2AqCLUR9F2C4/05cdbxjjLSRvMQIciEPCQZo++nk7go3BtSuK9kfa/s+a4f4i5pLkw=="
          crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="/resources/static/css/user/book.css">
</head>
...
<article>
    <div class="container">
        <div class="heading-page">
            <h1>Tìm kiếm</h1>
            <p class="subtxt">Có <strong>${findBook.size()}</strong> cho tìm kiếm</p>
        </div>
        <p class="subtext-result">Kết quả tìm kiếm cho  <strong><c:out value="${find}"/> </strong></p>
    </div>
    <div class="container">
        <div class="grid__row">
            <div class="col-lg-10 col-md-12 col-12 collection-content" style="margin-left:80px">
                <ul class="products">
                    <c:forEach var="bookcate" items="${findBook}">
                    <li>
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                <a href="/listbook/type/${bookcate.category.categoryID}" class="product-cat"><c:out value="${bookcate.category.categoryName}"/></a>
                                ...
                                <div class="product-price"><c:out value="${bookcate.price}"/></div>
                            </div>
                        </div>
                    </li>
                    </c:forEach>            </div>
