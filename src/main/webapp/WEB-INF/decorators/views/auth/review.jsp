...
<article>
    <div class="container my-5">
        <div class="product-image">
            <a href="/productbook/${billinfo.bookid.bookID}"><img src="<c:out value="${billinfo.bookid.avatar}"/>"></a>
        </div>
        <h1 class="product-title"><a href="/productbook/${billinfo.bookid.bookID}" style="text-decoration: none; color: black">
            <c:out value="${billinfo.bookid.title}"/></a></h1>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const defaultButton = document.querySelector(`.star-button[data-rating="5"]`);
        ...
        <div class="review-box">
            <input id="review-input" placeholder="Nhập ý kiến của bạn về sản phẩm"/>
            <button id="submit-review" onclick="Review()">Gửi đánh giá</button>
        </div>
        <script>
            function Review(){
                ...
                const bookid= ${billinfo.bookid.bookID};
                $.ajax({
                    type: "POST",
                    url: "/createreview",
                    data: {
