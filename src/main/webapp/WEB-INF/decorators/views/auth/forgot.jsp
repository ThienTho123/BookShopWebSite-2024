...
<head>
  ...
  <!-- Your Custom CSS -->
  <link rel="stylesheet" href="/resources/static/css/auth/forgot.css">
  <title>home</title>
</head>
<body>
<header>
    ...
    <div class="containerforgot">
      <div class="form-container">
        <div class="form-group">
          <h2 class="textforgot">Quên mật khẩu</h2>
        </div>
        <div class="form-group">
          <form action="/fill_email" method="post">
            <label for="email">Vui lòng nhập email của bạn</label>
            <input type="email" id="email" name="email" required>
            <button type="submit" class="send-email-button">GỬI EMAIL</button>
          </form>
        </div>
        <div class="form-group">
          <p style="font-style: italic">Quay lại đăng nhập <a href="/login">Đăng nhập</a></p>
        </div>
      </div>
    </div>
  </div>
